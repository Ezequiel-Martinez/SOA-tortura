...
int button_points_to_win; //cantidad de puntos que necesito para ganar
int keypad_points_to_win; //cantidad de puntos que necesito para ganar
int servo_degrees;
...
char key_map[NUM_ROWS_KEYPAD][NUM_COLS_KEYPAD] = { {'1', '2', '3'}, {'4', '5', '6'}, {'7', '8', '9'} };
...
void keypad_game(void)
{
  ...
  if(clear_lcd && lcd_clear_timer.finish_time - lcd_clear_timer.start_time >= max_keypad_game_time)
  {
    clear_lcd = false;
