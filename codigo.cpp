...
//Maquina de estados
enum State{ STATE_INIT, STATE_SENSOR, STATE_GAME_MODE, STATE_UNKNOWN, NUMBER_OF_STATES };
enum Event{ EVENT_CONT, EVENT_SENSOR_PRESSED, EVENT_SENSOR_RELEASED, EVENT_CHARACTER_B, EVENT_CHARACTER_K, EVENT_CHARACTER_N, EVENT_UNKNOWK, NUMBER_OF_EVENTS };
...
T_transition state_table[NUMBER_OF_STATES][NUMBER_OF_EVENTS] = 
{
  //EVENT_CONT , EVENT_SENSOR_PRESSED, EVENT_SENSOR_RELEASED, EVENT_CHARACTER_B, EVENT_CHARACTER_K, EVENT_CHARACTER_N, EVENT_UNKNOWK
    ...
    nop        , game_mode           , sensor               , error            , error            , error            , error,        //STATE_SENSOR
    nop        , game_mode           , sensor               , button_game      , keypad_game      , normal_game      , error,        //STATE_GAME_MODE
